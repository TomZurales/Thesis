...
The frontend is responsible for the coarse motion estimation of the system. It is capable of determining 2D relative motion between two images in the case of initialization, or 