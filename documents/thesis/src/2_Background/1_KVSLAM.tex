...
Loop closure is a technique used to account for drift during large scale KV-SLAM operations. Figure \ref{fig:loop_closure} shows the core ideas of the process
