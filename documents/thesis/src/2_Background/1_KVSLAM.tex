...
Loop closure is a technique used to account for drift during large scale KV-SLAM operations. Figure \ref{fig:loop_closure} shows the core idea behind the process.

\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\textwidth]{resources/loop_closure.png}
    \caption[Loop Closure Example]{An example of how loop closure can account for drift by constraining the trajectory based on detected loops.}
