...
An overview of relevant core concepts in KV-SLAM is provided below, followed by a discussion of the KV-SLAM subsystems which are relevant to this research. 
