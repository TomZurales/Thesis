...
In the context of this research, the 2D-3D correspondences between an image and the map are more likely to contain outliers and incorrect associations when the map contains outdated 
