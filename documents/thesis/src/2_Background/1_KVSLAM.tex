...
In the context of KV-SLAM, tracking refers to the process of estimating the real-time position and orientation of the camera, while mapping refers to the process of generating a 3D map of the environment. Tracking can be accomplished in two ways. The first way utilizes 2D-2D correspondences between two images taken at different viewpoints to simultaneously determine the 3D transformation between the two images, and the 3D depths of the matched features. 
