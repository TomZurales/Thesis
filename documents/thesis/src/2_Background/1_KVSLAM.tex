...
Image features can be matched between frames using their descriptors. For many features such as SIFT \cite{loweObjectRecognitionLocal1999}, SURF and ORB, the descriptor is a vector of floating point values which can be compared using a distance metric such as Euclidean distance or Hamming distance. 
