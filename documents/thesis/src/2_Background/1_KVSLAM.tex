...
Loop closure is a technique used to correct drift during large scale KV-SLAM operations. Figure \ref{fig:loop_closure} shows the core idea behind the process.
