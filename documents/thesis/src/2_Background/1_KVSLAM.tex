...
For this research, the existence of outdated map points in the map may cause the Bag-of-Words model to produce false positives or negatives, leading to incorrect relocalization or loop closure detections. 
