...
In the context of KV-SLAM, tracking refers to the process of estimating the position and orientation of the camera in the environment based on the features extracted from input images. Assuming a map 
