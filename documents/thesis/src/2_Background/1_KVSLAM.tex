...
In the context of KV-SLAM, tracking refers to the process of estimating the position and orientation of the camera in the environment based on the features extracted from input images, while mapping refers to the process of estimating the 3D positions of the map points based on the tracked features. The tracking and mapping processes are tightly coupled, 
