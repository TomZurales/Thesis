...
Map reuse is core to this research, as it is what allows SLAM to operate in the episodic operating model. By loading a previously generated map into the SLAM system, we allow the sy