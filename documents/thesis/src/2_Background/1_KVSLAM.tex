...
With the general structure of hte Integration of the VD-OMR system falls under the purview of the backend, as it is an extension to the existing point culling maintenance task. But this raises the question of why are map points culled in the first place?