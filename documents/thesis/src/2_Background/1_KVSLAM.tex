...
Notice that RANSAC relies on the assumption that only a small proportion of the data is outliers. If the proportion of outliers is too high, RANSAC may fail to find a solution that explains a sufficient number of inliers. In the
