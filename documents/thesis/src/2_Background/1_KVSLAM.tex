...
This research is tied to the structures and inner workings of KV-SLAM, so an overview of the concepts and techniques used in KV-SLAM is provided below. The 
