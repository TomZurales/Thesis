...
In the context of KV-SLAM, tracking refers to the process of estimating the position and orientation of the camera, either relative to a global map, or to the previous frame.
