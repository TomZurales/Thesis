...
Loop closure is a technique used to account for drift during large scale

\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\textwidth]{resources/loop_closure.png}
    \caption[Loop Closure Example]{(Top) ORB features extracted from two frames of the EuRoC MAV V1\_03 dataset \cite{burriEuRoCMicroAerial2016}. (Bottom) Corresponding ORB feature matches between the two frames.}
