...
The backend is responsible for integrating the coarse motion estimates and map points from the frontend into the larger context of the global map and trajectory. Additionally, depending on the implementation, the backend may perform several maintenance tasks designed to 