...
The VD-MPR system being studied will be implemented within ORB-SLAM3, a popular KV-SLAM implementation A full description of the internal operations of KV-SLAM is out of scope for this thesis, but an overview of key concepts relevant to this research is given below, followed by a discussion of the KV-SLAM subsystems which are relevant to this research.
