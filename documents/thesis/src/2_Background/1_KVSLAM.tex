...
In the context of KV-SLAM, tracking refers to the process of estimating the real-time position and orientation of the camera, while mapping refers to the process of generating a 3D map of the environment. These two processes are highly interdependent, as correspondences between the images and the map determine the camera's position, and the camera's positions determine the locations of the 3D map points. 
