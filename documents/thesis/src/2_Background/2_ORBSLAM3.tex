...
To relate the sections of Figure \ref{fig:orb-slam3} to the processes described previously, both the frontend and backend are performing tracking and mapping. The frontend is responsible for coarse motion estimation and map point generation in real-time