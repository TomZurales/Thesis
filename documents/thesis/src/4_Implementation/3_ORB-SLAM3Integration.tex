...
These criteria are effective for quickly removing false matches, but as the map point culling process only operates only recently added map points, it has no effect on map points which are considered established which may no longer exist.
