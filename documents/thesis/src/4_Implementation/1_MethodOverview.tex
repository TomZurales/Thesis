...
The proposed existence estimation framework iteratively updates a per-point probability of existance in a reused KV-SLAM map using historical observability priors and current observations. As shown in \ref{fig:existence_estimation_framework}, the framework consumes new observational data, and produces an updated estimate of the point's probability of existence.
