...
For the purposes of the mathematical formulation of the update and query functions, the geometric details of the icosahedral shell are not relevent. The specifics of the geometric construction used in this work are discussed in Section \ref{sec:icos_construction}.
