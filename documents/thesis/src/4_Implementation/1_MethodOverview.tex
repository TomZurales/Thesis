...
The existence estimation framework intends to iteratively update a confidence estimate for each map point in a reused KV-SLAM map using prior observability 
