...
The generation of such a plot would require the generation and storage of infinite observations taken from across the domain of viewpoints. Therefore, the models described below must instead operate on a finite number of observations, or a constant set of metadata
