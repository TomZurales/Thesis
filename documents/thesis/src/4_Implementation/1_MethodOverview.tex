...
\subparagraph{Icosahedral Shell Mathematical Formulation}

For the purposes of the mathematical derivation of the update and query functions, the construction of the Icosahedral shell is arbitrary. The specifics of the geometric construction used in this work are discussed in Section \ref{sec:icos_construction}.
...
Additionally, we require a function $\phi:\mathbb{S}^2\rightarrow\{1..20\}$ which maps unit vectors to the face through which they point. This function can be defined as

With these constructs in hand, we can define the update and query functions for the icosahedral shell.

\subparagraph{The Update Function}

\subparagraph{The Query Function}
