...
The observability model has two purposes: to estimate the probability of a map point being seen from a given viewpoint, and to integrate new observations of the map point into its internal representation of the point's observability. 
