...
Map points are conceptualized as static, infinitesimally small points in 3D Euclidean space. Additionally,  This means that the visibility of a map feature can be represented by the function
$$
