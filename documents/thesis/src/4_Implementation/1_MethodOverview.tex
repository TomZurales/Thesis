...
\begin{figure}[!ht]
    ...
    \caption[Overall Observability]{A 2D representation of the global observability of a map point $p$ with high overall observability (left) and with low observability (right).}
