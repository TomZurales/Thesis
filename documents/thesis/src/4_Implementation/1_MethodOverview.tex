...
For the purposes of the mathematical derivation of the update and query functions, the construction of the Icosahedral shell is arbitrary. The specific construction used in this work will be discussed in Section \ref{icos_construction}, but for this high level overview, we assume the existence of the following constructs:

\begin{list}
    \item{A vector of faces F}
\end{list}
