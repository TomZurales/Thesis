...
The goal of the model is to minimize the total error between the estimated observability and the actual observability using a finite set of $n$ observations O. Observations
