...
For the purposes of the mathematical derivation of the update and query functions, the construction of the Icosahedral shell is arbitrary. The specific construction used in this work will be discussed in Section \ref{icos_construction}
