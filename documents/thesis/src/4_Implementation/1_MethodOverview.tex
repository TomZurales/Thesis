...
The goal of the model is to estimate the observability of a point using a finite set of $n$ observations $\boldsymbol{O$, and a current viewpoint. Observations take the form $o_n={theta_n,\phi_n,d_n,seen_n}$, so the model can be written
$$
