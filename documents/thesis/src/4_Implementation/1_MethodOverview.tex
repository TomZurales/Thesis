...
The proposed existence estimation framework iteratively updates a per-point existence probability in reused KV-SLAM maps using historical observability priors and current observations. As shown in Figure \ref{fig:existence_estimation_framework}, the framework consumes new observational data, and outputs an updated estimate of the point's probability of existence.
