...
A simple method for modeling the observability is the use of a K-nearest-neighbors clustering method. The parameters of interest in such a model would be 
