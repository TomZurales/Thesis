...
Map points are conceptualized as static, infinitesimally small points in 3D Euclidean space. The observability of a map point $p$ from a viewpoint $\boldsymbol{v} = {\theta,\phi,d}$
$$
