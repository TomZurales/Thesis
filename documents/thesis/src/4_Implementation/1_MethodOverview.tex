...
For the purposes of constructing a historical observability model for map points, a few assumptions will need to be in place to constrain the problem. First, we assume the environment is static during mapping operations. are infinitesimally small
