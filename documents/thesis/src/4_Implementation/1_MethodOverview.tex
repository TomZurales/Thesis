...
In this model, each observation is assigned to a bin based on the unit direction of observation. Each bin stores the total number of observations which occur within it, 
