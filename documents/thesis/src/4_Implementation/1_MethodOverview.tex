...
Overall observability represents the proportion of viewpoints from which the map point is observable to the total number of viewpoints. This knowledge is integrated into the existence estimator using an additional parameter $q$. This new parameter is updated based on the difference between the model's estimate of the 