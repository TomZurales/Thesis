...
A simple method for modeling the observability is the use of a K-nearest-neighbors clustering method. Figure \ref{fig:knn} shows a K-nearest neighbors model wi
