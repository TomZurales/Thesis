...
Let's step back for a moment recall the goal of this research. We are attempting to identify previously observed map points which are no longer observable in the map. Viewpoint-aware observability is a function characterized by a unit direction vector $\mathbf{v}\in\mathbb{S}^2$ and a distance $d\in\mathbb{R}^+$
$$
