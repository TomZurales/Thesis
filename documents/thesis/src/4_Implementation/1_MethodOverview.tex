...
It should be noted that within, a map point which is occluded from a viewpoint $\{\theta, \phi, d\}$ will also be occluded from any viewpoint $\{\theta, \phi, d'\}$ where $d'>d$
