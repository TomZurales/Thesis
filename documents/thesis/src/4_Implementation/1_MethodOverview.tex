...
The proposed existence estimation framework iteratively updates a per-point confidence estimate in a reused KV-SLAM maps using historical observability priors and current observations. As shown in \ref{fig:existence_estimation_framework}, the framework consumes new observational data, and produces an updated probability of the point's existence.
