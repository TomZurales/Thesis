...
We define our icosahedral shell $\mathcal{S}$ as a construct of 20 faces $\mathcal{F}$. Each face carries parameters $d\in\mathbb{R}^+$ representing the maximum distance at wich the point has been viewed through that face, and $p\in[0,1]$
% \begin{multline}
