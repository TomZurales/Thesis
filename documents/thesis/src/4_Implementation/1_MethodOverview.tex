...
Let's step back for a moment recall the goal of this research. We are attempting to identify previously observed map points which are no longer observable in the map. This can be accomplished by updating each map point's overall probability of existence using a Bayesian update step.
