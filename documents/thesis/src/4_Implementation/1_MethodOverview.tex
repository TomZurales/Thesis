...
For the purposes of KV-SLAM, map features can be conceptualized as static, infinitesimally small points in 3D space. Because they have no width or height, they can never be partially obscured, and are immune to perspective. For the purposes of map point observability
