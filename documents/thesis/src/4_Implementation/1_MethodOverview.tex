...
It should be noted that due to the constraints imposed by Euclidean space, a map point which is occluded from a viewpoint $\{\theta, \phi, d\}$ will also be occluded from any viewpoint $
