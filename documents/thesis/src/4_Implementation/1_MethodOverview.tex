...
It should be noted that due to the constraints imposed by Euclidean space, a map point which is occluded from a viewpoint $\{\theta, \phi, d\}$ will always be occluded from a viewpoint 
