...
To better clarify the meaning of map point observability, map features can be conceptualized as static, infinitesimally small points in 3D Euclidean space. This means that the visibility of a map feature can be represented by the function
$$
