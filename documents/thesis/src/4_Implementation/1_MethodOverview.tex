...
The observability model performs two functions: estimating the probability of a map point being seen from a given viewpoint, and integrating new observations of the map point into its internal representation. The estimation function returns a 
