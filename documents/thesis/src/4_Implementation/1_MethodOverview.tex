...
The generation of such a plot would require the generation and storage of infinite observations across the full domain. As this is impractical for SLAM integration, the models must instead operate on a 
