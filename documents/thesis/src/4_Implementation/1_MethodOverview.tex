...
$$
    v:(\theta,\phi,d):[0,2\pi)\times\left[-\frac{\pi}{2},\frac{\pi}{2}\right]\times[0,\inf)\to{0,1}
$$
where $\theta\in[0,2\pi)$ represents the azimuth between the observer and the map feature, $\phi\in\left[-\frac{\pi}{2},\frac{\pi}{2}\right]$ represents the elevation of the observer above the map point, and $d\in[0,\inf)$ represents the distance between the feature and the observer
