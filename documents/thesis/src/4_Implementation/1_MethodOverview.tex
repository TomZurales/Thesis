...
The goal of the model is to estimate the global observability of a point using a finite set of $n$ observations $\boldsymbol{O} = \{o_0,\dots,o_n\}$, and a current viewpoint $\boldsymbol{v}$. Additionally, based on the model implementation, a set of parameters $\boldsymbol{x} = 
$$
