...
For the purposes of constructing a historical observability model for map points, a few assumptions will need to be in place to constrain the problem. As we are working in the are infinitesimally small
