...
The observability model performs two functions: estimation of the probability of a map point being seen from a given viewpoint, and the integration of new observations into its internal representation.
