...
The observability model has two purposes: to estimate the probability of a map point being seen from a given viewpoint, and to integrate new observations into 
