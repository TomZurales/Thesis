...
Let $M=\{mp_i\}_{i=0}^{n_{mp}}$ represent a map $M$ containing $n_{mp}$ map points. Let $S_i=\{F_j\}_{j=1}^{20}$ represent the icosahedral shell $S$ attached to $mp_i$, containing 20 faces $F_{1\.20}
