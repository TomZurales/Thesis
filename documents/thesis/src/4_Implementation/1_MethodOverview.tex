...
Map points are conceptualized as static, infinitesimally small points in 3D Euclidean space. The observability of a map point $p$ from a viewpoint $\boldsymbol{v} = {\theta,\phi,d}\in[0,2\pi)\times\left[-\frac{\pi}{2},\frac{\pi}{2}\right]\times[0,\infty)$
$$
