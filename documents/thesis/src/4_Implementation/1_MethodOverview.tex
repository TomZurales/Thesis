...
The observability model performs two functions: estimation of the probability of the map point being seen from a given viewpoint, and the integration of new observations into its internal representation. The estimation function is defined as
$$
    \operatorname{modelestimate} : V \to [0,1],\quad \operatorname{m}(\boldsymbol{v})=
$$
