...
The implementations explored in this thesis serve as a sample of possible methods for modeling map point observability. While not exhaustive, these methods provide a foundation for future research 
