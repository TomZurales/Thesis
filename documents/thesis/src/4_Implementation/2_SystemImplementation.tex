...
Each model described below is parameterized by a vector of inputs, the selection of which will be completed through an optimization process in Section \ref{sec:model_optimization}.
