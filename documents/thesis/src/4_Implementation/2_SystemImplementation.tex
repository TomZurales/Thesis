...
\begin{
\defitem{$k$}{The maximum number of neighboring observations used to estimate $P(S^{\boldsymbol{v}}|E)$}

\defitem{$n$}{The maximum number of observations that can be stored in the internal representation}\newline
