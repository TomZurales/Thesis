...
\begin{algorithm}[H]
    ...
    \begin{algorithmic}[1]
        ...
        \Require Global observations $(\theta_i, \phi_i, d_i, \text{seen}_i)$
        ...
        \State $candidates.\texttt{append}((dist, \text{seen}_i))$
        \EndIf
        \EndFor
        ...
        \State \Return $0.5$
        \EndIf
        \State $positives \gets$ count of entries in $k\_neighbors$ where $\text{seen} = \text{True}$
