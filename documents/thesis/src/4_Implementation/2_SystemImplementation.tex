...
The implementations presented here are not intended to cover all possible methods of modeling and integrating map point observability, but instead to provide a representative sample of various methods which could be expanded on in the future. 
