...
The implementations presented here are not intended to cover all possible methods of modeling and integrating map point observability, but instead to provide a representative sample of the various methods 
