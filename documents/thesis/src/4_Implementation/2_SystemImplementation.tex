...
A simple method for modeling the observability is the use of a K-nearest-neighbors clustering method. This model assumes that a point with many nearby positive observations will be positive, many nearby negative observations will be negative, and a mix of the two to be somewhat uncertain. This implementation uses the following parameters
