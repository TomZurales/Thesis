...
Each model described below is parameterized by a vector of inputs representing various tunable parameters, the selection of which will be completed through an optimization process in Section \ref{sec:parameter_tuning}. 
