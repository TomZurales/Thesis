...
\begin{algorithm}[H]
    ...
    \begin{algorithmic}[1]
        ...
        \Require Global observations $(\theta_i, \phi_i, \text{is\_positive}_i)$
        \Require $k$, \texttt{max\_angle}
        \Ensure Probability of existence
