...
A simple method for modeling the observability is the use of a K-nearest-neighbors clustering method. This model estimate $P(S^{\boldsymbol{v}}|E)$ to be the proportion of  to $\boldsymbol{v}$ which were successful to the total number of 
