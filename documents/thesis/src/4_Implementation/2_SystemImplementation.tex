...
A simple method for modeling the observability is the use of a K-nearest-neighbors clustering method. This model weights its estimate of $P(S^{\boldsymbol{v}}|E)$ based 
