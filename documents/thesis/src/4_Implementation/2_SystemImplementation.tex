...
A simple method for modeling the observability is the use of a K-nearest-neighbors clustering method. This model assumes that a point with many nearby positive observations will be positive
