...
This research introduces a novel method of map point removal for reused maps in keypoint-based visual SLAM systems, and will attempt to answer the following questions:

\subsubsection*{Question 1. Does a point-level understanding of }
