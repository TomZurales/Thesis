...
Integrating historical viewpoint-dependent observability into existing change detection approaches requires a compact model of observability at the point level. Three model implementations are explored in section \ref{sec:observability_models} and evaluated in section \ref{sec:observability_model_eval}.
