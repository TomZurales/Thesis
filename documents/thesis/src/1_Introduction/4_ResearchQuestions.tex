...
\subsubsection*{Question 1: How can the historical viewpoint-dependent observability be modeled in order to meet the objectives laid out in Section \ref{sec:objective_1}?}
