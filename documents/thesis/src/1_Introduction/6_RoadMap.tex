...
Chapter \ref{sec:conclusion} aggregates the results from chapter \ref{sec:analysis}, and evaluates them against the defined objectives of this research to determine whether this method is an effective solution to the problems discussed so far.