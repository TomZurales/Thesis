...
Chapter \ref{sec:implementation} discusses the implementation of a viewpoint-dependant historical observability model, and its integration into ORB-SLAM3. 
