...
SLAM is extremely flexible in terms of what sensor inputs it can use, and the methodologies used to run it. But for the use case laid out so far, the desired system acts essentially as a 
