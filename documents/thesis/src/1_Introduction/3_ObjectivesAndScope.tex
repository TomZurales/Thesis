...
This research is focused on outdated map reuse, and therefore should not affect the performance of the SLAM system when not reusing an outdated map. The system should perform identically 
