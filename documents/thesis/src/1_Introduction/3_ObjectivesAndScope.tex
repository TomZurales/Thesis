...
The objective of this research is to integrate viewpoint accurately identify outdated map points in reused keypoint-based visual SLAM maps by integrating point-level directional observability into the update step of map point confidence.
