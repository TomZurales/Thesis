...
\subsubsection*{Objective 1: Implementation of a Viewpoint-Dependent Outdated Map Point Removal Method (VD-OMR)}
...
To verify the performance and effectiveness of the VD-OMR method, it must be implemented into an exiting SLAM system, and benchmarked in various scenarios.
