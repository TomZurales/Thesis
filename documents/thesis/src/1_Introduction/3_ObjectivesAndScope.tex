...
The system implemented will need to perform several functions concurrently with other SLAM system operations, meaning each needs to be fast enough to avoid delaying 
