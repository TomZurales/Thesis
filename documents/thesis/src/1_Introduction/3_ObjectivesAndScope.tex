...
The objective of this research is to integrate historical viewpoint-dependent observability into the calculation of whether or not a map point is outdated. The applications of this integration are wide, but for this research, we focus on the specific use case of eliminating outdated map points from reused keypoint-based visual SLAM maps in stochastic SLAM operations.
