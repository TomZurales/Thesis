...
This research has two primary objectives. The first is the implementation a novel map point removal method which integrates the historical viewpoint-dependent observability of . The second is the integration of this map point removal method into an existing KV-SLAM system. 
