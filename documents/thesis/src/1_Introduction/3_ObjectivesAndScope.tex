...
SLAM is extremely flexible in terms of what sensor inputs it can use, and the methodologies used to run it. But for the cases laid out so far such as the ISS, the desired system operates more as a self-updating localizer than a full SLAM system. Of course, 
