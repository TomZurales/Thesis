...
The objective of this research is to improve map reuse in keypoint-based visual SLAM through a novel change detection technique which integrates the historical viewpoint-dependent observability of a map point into the calculation of whether it has become outdated or is still relevant.
