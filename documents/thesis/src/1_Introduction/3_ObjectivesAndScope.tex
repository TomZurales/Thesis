...
The objective of this research is to integrate historical viewpoint-dependent observability into the calculation of whether a map point is outdated or is still relevant, and to . This capability may be relevant in other applications, but we focus on the specific use case of eliminating outdated map points from reused keypoint-based visual SLAM maps in stochastic SLAM operations. We can break this objective down into several prerequisites which must be completed before the objective can be called complete.
