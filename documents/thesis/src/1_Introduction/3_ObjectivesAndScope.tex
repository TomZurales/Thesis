...
The objective of this research is to integrate historical viewpoint-dependent observability into the decision of whether o awareness into the accurately identify outdated map points in reused keypoint-based visual SLAM maps by integrating point-level directional observability into the update step of map point confidence.
