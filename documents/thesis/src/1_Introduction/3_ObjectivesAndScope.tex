...
The objective of this research is to improve upon existing change detection techniques for outdated map point removal when reusing maps in scholastic keypoint-based visual SLAM scenarios. 
