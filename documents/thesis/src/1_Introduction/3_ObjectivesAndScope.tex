...
The methods presented in this research will not work for all SLAM generated maps. While change detection techniques do exist for sparse maps \cite{PLACEHOLDER},
