...
This research has two primary objectives. The first is the implementation a novel map point removal method which integrates the historical point-level viewpoint-dependent observability of map points into the . The second is the integration of this map point removal method into an existing KV-SLAM system. 
