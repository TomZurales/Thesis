...
The objective of this research is to integrate historical viewpoint-dependent observability into the decision of whether to flag a map point as outdated. The applications for 
