...
The objective of this research is to integrate the historical viewpoint-dependent observability of a map point into the determination of whether it has become outdated or is still relevant.  may be relevant in other applications, but we focus on the specific use case of eliminating outdated map points from reused keypoint-based visual SLAM maps in stochastic SLAM operations. We can break this objective down into several prerequisites which must be completed before the objective can be called complete.
