...
The objective of this research is to integrate historical viewpoint-dependent observability into the decision of whether to flag a map point as outdated. The applications of this ability are wide, but for this research, we focus on a specific use case
