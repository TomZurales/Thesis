...
The objective of this research is to improve upon existing change detection techniques for outdated map point removal when reusing maps in scholastic keypoint-based visual SLAM scenarios using a probabilestic update predicated on the global observability of . This objective needs to be unpacked to understand what is and is not covered by the 
