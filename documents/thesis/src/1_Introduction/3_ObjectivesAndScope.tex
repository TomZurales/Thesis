...
A core feature of the stochastic operational model is that an indeterminate amount of time passes between runs. In a changing environment, this means the low-level visual features of the environment will change (e.g. furniture moved around, clutter picked up, etc.) 
