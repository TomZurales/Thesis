...
With these objectives in hand, we can now define a set of questions which, when answered, will determine whether the goals of the objectives have been successfully 
