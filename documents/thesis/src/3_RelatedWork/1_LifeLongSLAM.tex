...
\begin{singlespace}
    ...
    \end{enumerate}
\end{singlespace}
This research adopts the definition provided by Shi et al. \cite{shiAreWeReady2020}, describing lifelong SLAM as the ability for a robot operating in a particular area over a long time period to build and maintain a persistent map of its region