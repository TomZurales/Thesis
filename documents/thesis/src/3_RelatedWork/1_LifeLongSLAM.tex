...
ORB-SLAM3 does not perform map maintenance, instead opting to always add the latest information to the map \cite{camposORBSLAM3AccurateOpenSource2021}. This 