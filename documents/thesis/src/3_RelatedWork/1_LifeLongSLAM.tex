...
\begin{singlespace}
    ...
    \end{enumerate}
\end{singlespace}
This research adopts the definition provided by Shi et al., describing lifelong SLAM as the ability for a robot to operate in a particular area over a long time period