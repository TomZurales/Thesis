...
\input{src/2_Background/1_VKSLAM}

% Only keep if you get into the continuous implementation. Otherwise just bump the SLAM Background section up a level
\input{src/2_Background/2_DirectionalStatisticsBackground}
