...
Change detection in SLAM refers to identifying discrepencies between current sensor observations and the existing map. It supports lifelong SLAM and episodic operations by providing a mechaninism for the identification of outdated map 
