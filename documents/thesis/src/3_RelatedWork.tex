...
Dynamic rejection is the process of identifying dynamic objects within a scene, and rejecting image features which fall on them. This often requires image segmentation and semantic identification, 
