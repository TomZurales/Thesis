...
Change detection in SLAM refers to identifying discrepencies between the current sensor observations, and the existing map. It supports lifelong SLAM and episodic operations by allowing maps to identify and remove out of date elements.
\begin{enumerate}
    \item Register new observations to their respective positions in the map
