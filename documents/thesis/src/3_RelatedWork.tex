...
Many modern methods utilize a learning-based approach to align and detect changes in dissimilar data types. Larsen et al. \cite{larsenChangeDetectionModel} detected changes between a 3D mesh and 2D point clouds to 
