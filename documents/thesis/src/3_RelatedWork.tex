...
Learning-based methods like NetVLAD \cite{arandjelovicNetVLADCNNArchitecture2016} and XXX assign global descriptors to places rather than features, increasing robustness to viewpoint and condition changes, but 
