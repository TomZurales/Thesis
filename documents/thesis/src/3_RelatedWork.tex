...
As previously discussed, place recognition refers to the ability to realize when an agent has entered a previously visited area. In KV-SLAM, this is regularly accomplished using a bag-of-words approach on binary feature discriptors extracted from localized images \cite{camposORBSLAM3AccurateOpenSource2021}. However, as operational duration and scale increase, this method fails for two key reasons. First, Early methods such as Naseer et al. \cite{naseerVisionbasedMarkovLocalization2015}
