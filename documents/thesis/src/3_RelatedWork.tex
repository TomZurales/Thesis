...
The implementations underlying these operations vary with sensor modality and map representation. Derner et al. \cite{dernerChangeDetectionUsing2021} weight visual features 
