...
Change detection in SLAM refers to identifying discrepencies between the current sensor observations, and the existing map. It supports lifelong SLAM by allowing maps to identify out of date elements
\begin{enumerate}
