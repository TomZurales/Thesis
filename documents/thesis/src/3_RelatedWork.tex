...
Change detection in SLAM refers to identifying discrepencies between current sensor observations and the existing map. For lifelong SLAM, map maintenance is necessary 
