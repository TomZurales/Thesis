...
Dynamic rejection is the process of identifying dynamic objects within a scene, and rejecting image features which fall on them. This requires either tracking object motion to verify the object is dynamic, or performing image segmentation and 
