...
Implementations vary in their level of abstraction. For clarity, this research splits these topics into two cases: point-level change detection and object-level change detection
