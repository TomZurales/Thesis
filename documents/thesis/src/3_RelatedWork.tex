...
As previously discussed, place recognition refers to the ability to realize when an agent has entered a previously visited area. In KV-SLAM, this is regularly accomplished using a bag-of-words approach on binary feature discriptors extracted from localized images \cite. However, the extracted features can change significantly over time due to lighting changes, moved objects, viewpoint, etc. The ideal place recognition would be robust to small-scale scene dynamics, while accurately identifying and matching large scale robust features. Early methods such as Naseer et al. \cite{naseerVisionbasedMarkovLocalization2015}
