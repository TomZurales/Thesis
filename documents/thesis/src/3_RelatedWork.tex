...
The implementation of change detection depends on sensor modality and map representation, but can be split into three categories: appearance-based, geometry-based, and semantic
