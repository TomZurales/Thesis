...
Dynamic rejection is the process of identifying dynamic objects within a scene, and rejecting image features which fall on them. This requires either tracking object motion to verify the object is dynamic, or performing image segmentation and semantic identification to categorize objects as either dynamic or static. This can also be accomplished whithout strict object identification using methods which can detect movememnt in images like optical flow or in point clouds like 
