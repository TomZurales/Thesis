...
Girardeau-Montaut et al. \cite{girardeau-montautCHANGEDETECTIONPOINTS2005} implemented point cloud change detection by alligning temporally spaced laser scans using iterative closest point (ICP)
