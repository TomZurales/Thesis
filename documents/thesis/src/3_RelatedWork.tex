...
As previously discussed, place recognition refers to the ability to realize when an agent has entered a previously visited area. In KV-SLAM, this is regularly accomplished using a bag-of-words approach on binary feature discriptors extracted from localized images. However, the extracted features can change significantly over time due to weather, lighting, 
