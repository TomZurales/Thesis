...
\begin{enumerate}
    \item Correlate new observations to their respective positions in the map
    \item Update the map in a meaningful way as to reflect the changes
\end{enumerate}
The implementations underlying these operations vary greatly with sensor modality and map representation.
