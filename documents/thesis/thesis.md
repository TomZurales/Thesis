...
The situation on the ISS is not unique, and would be experienced by any agent running SLAM in all but the most tightly controlled environments. VR goggles which use SLAM to determine their position in 3D space within a room must contend with new 
