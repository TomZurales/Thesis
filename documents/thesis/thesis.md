...
The term Keypoint-Based Visual SLAM refers to the SLAM modality which primarily utilizes key points extracted from images as the primary means of mapping and navigating. This is in contradistinction to systems like LIDAR-based SLAM, 
