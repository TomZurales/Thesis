...
Through this research, we develop an incrementally updated direct, priorless, constant space and time probability model for the existence of map points. This model is implemented as an icosahedral shell surrounding each map point, providing metadata regarding observability at 20 unique perspectives.
