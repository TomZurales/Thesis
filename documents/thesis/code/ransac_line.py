...
ax2.set_xlim(0, 10)
ax2.set_ylim(0, 10)
ax2.set_title('Random Sample with Low Consensus', fontsize=14)
...
fig.legend(handles=legend_elements, loc='lower center', ncol=3, bbox_to_anchor=(0.5, 0.02), fontsize=14)
