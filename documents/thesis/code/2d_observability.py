...
obs.add_barrier(Barrier(Point(np.pi / 4, 0.4, True), Point(-np.pi / 4, 0.4, True)))
obs.add_barrier(Barrier(Point(np.pi / 4, 0.4, True), Point(0.5, 3 * np.pi / 2, True)))
...
ax1.plot(0, 0, "ro", markersize=8, label="p")
